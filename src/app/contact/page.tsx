    ...
    <main className="min-h-screen bg-white">
      ...
      <PageHeader 
        ...
        valueBoxes={[
          ...
          { icon: Headphones, label: 'Direct Access', sublabel: 'Director-Led' }
        ]}
      />
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              ...
              <BlurFade delay={0.2}>
                 <div className="bg-white rounded-[2rem] p-8 border border-slate-200 flex items-start gap-5 shadow-sm">
                    ...
                    <div>
                       <h4 className="font-black font-serif text-[#0f172a] text-xl mb-2">24-Hour SLA</h4>
            ...
            <div className="lg:col-span-7">
               <BlurFade delay={0.3} className="bg-white rounded-[3rem] p-10 md:p-16 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-100 h-full flex flex-col justify-center">
                  <div className="mb-12">
                    ...
                    <h3 className="text-4xl md:text-5xl font-serif font-black text-[#0f172a] mb-6 tracking-tighter leading-tight">
                      Establish Your <br />
                  ...
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input className="w-full bg-slate-50 border border-slate-100 rounded-[1.5rem] p-5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#0284c7]/20 focus:bg-white transition-all font-medium" placeholder="E.g. Sarah Mitchell" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Facility Name</label>
                        <input className="w-full bg-slate-50 border border-slate-100 rounded-[1.5rem] p-5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#0284c7]/20 focus:bg-white transition-all font-medium" placeholder="E.g. Evolve Care Center" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Work Email</label>
                      <input type="email" className="w-full bg-slate-50 border border-slate-100 rounded-[1.5rem] p-5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#0284c7]/20 focus:bg-white transition-all font-medium" placeholder="your@facility.com" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Primary Inquiry Goal</label>
                      <select className="w-full bg-slate-50 border border-slate-100 rounded-[1.5rem] p-5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#0284c7]/20 focus:bg-white transition-all font-medium appearance-none cursor-pointer">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea rows={4} className="w-full bg-slate-50 border border-slate-100 rounded-[2rem] p-6 text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#0284c7]/20 focus:bg-white transition-all font-medium resize-none" placeholder="Tell us about your current therapy status..." />
                    </div>
                    
                    <button type="button" className="w-full mt-8 focus:outline-none">
                      <ShimmerButton background="#0284c7" shimmerColor="rgba(255,255,255,0.4)" borderRadius="9999px" className="w-full py-6 group shadow-xl">
                        <span className="font-black uppercase tracking-[0.3em] text-[11px] text-white">Initialize Partnership</span>
                        <ArrowRight size={18} className="ml-3 group-hover:translate-x-1 transition-transform" />
                      </ShimmerButton>
                    </button>
                    
                    <p className="text-center text-slate-400 text-xs font-light mt-6">
