           ...
           <div className={cn(
             ...
             <div className="absolute w-[320vw] h-[320vh] top-[-110vh] left-[-160vw] pointer-events-none select-none overflow-hidden">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/8_nVbI7NcOw?autoplay=1&mute=1&loop=1&controls=0&showinfo=0&rel=0&playlist=8_nVbI7NcOw&modestbranding=1&playsinline=1&enablejsapi=1"
            ...
            <BlurFade delay={0.2}>
               ...
               <div className="mb-20 w-full">
                  <p className="text-xl md:text-2xl text-white/40 font-light leading-relaxed border-l-4 border-[#0284c7] pl-10 italic max-w-5xl">
                     We empower facility operators to successfully transition and manage high-performance in-house therapy teams through a comprehensive clinical ecosystem of specialized education, real-time audit oversight, and revenue-optimizing data intelligence.
                  </p>
               </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-12">
                     <div className="flex items-center gap-6 group">
                        ...
                        <div className="flex flex-col">
                           ...
                           <span className="text-white/20 text-[13px] font-light italic">"Creative Consulting"</span>
                        </div>
                     </div>
                     <div className="flex items-center gap-6 group">
                        <div className="w-14 h-14 rounded-2xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-[#0284c7] shadow-2xl backdrop-blur-xl group-hover:bg-[#0284c7] group-hover:text-white transition-all duration-500">
                        ...
                        <div className="flex flex-col">
                           ...
                           <span className="text-white/20 text-[13px] font-light italic">"Results Driven"</span>
                        </div>
                     </div>
                  </div>
               </div>
