      ...
      <div className="relative z-50 container mx-auto px-5 sm:px-6 lg:px-12 py-12 sm:py-20 flex-1 flex flex-col justify-center">
        <div className="w-full flex flex-col items-center text-center lg:items-start lg:text-left">
          <BlurFade delay={0.2}>
             ...
             <h1 className="text-[2.25rem] sm:text-5xl md:text-7xl lg:text-[100px] font-serif font-black text-white leading-[1.1] sm:leading-[0.9] tracking-tighter mb-8 sm:mb-16 drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)] uppercase w-full break-words" data-tina-field={tinaFields?.title}>
                {title}
                {italicWord && (
