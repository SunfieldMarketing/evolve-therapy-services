              ...
              <div className={`h-full p-10 rounded-[3rem] border transition-all duration-500 flex flex-col justify-between group ${
                ...
                <div className={`pt-8 border-t ${tier.featured ? 'border-white/10' : 'border-slate-200'}`}>
                   {tier.featured ? (
                     ...
                     <a href="/contact" className="w-full inline-flex items-center justify-center py-4 rounded-2xl border border-[#0f172a]/10 font-black text-[10px] uppercase tracking-[0.2em] hover:bg-[#0f172a] hover:text-white transition-all">
                       Learn More
                     </a>
                   )}
                </div>
