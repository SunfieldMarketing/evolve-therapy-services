      ...
      <div className="container mx-auto px-5 sm:px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 md:gap-12 mb-14 md:mb-20">
          <div className="max-w-3xl">
            ...
            <BlurFade delay={0.2}>
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-serif font-black text-[#0f172a] leading-[0.95] tracking-tighter">
                Comprehensive <br />
                <span className="text-[#0284c7] font-serif font-medium italic">Management Solutions</span>
              </h2>
            </BlurFade>
          </div>
          <BlurFade delay={0.3} className="text-xl text-slate-400 max-w-md leading-relaxed pb-2 font-light">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8 lg:gap-10">
          {services.map((service, i) => (
            <BlurFade
              key={i}
              delay={0.1 + i * 0.1}
              className="bg-slate-50 p-7 sm:p-10 md:p-12 rounded-3xl md:rounded-[3.5rem] border border-slate-100 hover:bg-white hover:border-[#0284c7]/20 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] transition-all duration-700 group relative flex flex-col justify-between overflow-hidden"
            >
              <Link href={service.href} className="absolute inset-0 z-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0284c7] focus-visible:ring-offset-2 rounded-3xl md:rounded-[3.5rem]" aria-label={`Learn more about ${service.title}`} />
              ...
              <div>
                <div className={`w-16 h-16 ${service.bg} ${service.color} rounded-[1.5rem] flex items-center justify-center mb-10 border border-white shadow-xl shadow-black/5 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 relative z-10`}>
                  <service.icon size={28} strokeWidth={1.5} />
                </div>
                
                <h3 className="relative z-10 text-2xl font-serif font-black text-[#0f172a] mb-5 leading-tight group-hover:text-[#0284c7] transition-colors duration-500">{service.title}</h3>
                <p className="relative z-10 text-slate-500 leading-relaxed mb-12 text-sm font-medium">
                  {service.desc}
                </p>
              </div>
        ...
        <BlurFade 
          delay={0.4}
          className="mt-16 md:mt-28 bg-[#0f172a] rounded-3xl md:rounded-[4rem] overflow-hidden shadow-2xl relative border border-white/5 group"
        >
          ...
          <div className="grid lg:grid-cols-2 relative z-10">
            <div className="p-8 md:p-14 lg:p-24 flex flex-col justify-center relative z-10 bg-[#0f172a]/80 backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none">
              <BlurFade delay={0.5} className="mb-12">
            ...
            <div className="relative min-h-[500px] overflow-hidden lg:h-auto z-0">
               <Image 
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[#0f172a] via-[#0f172a]/60 to-transparent lg:w-[60%]" />
