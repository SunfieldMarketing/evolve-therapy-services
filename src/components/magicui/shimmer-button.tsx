...
/**
 * Magic UI ShimmerButton — glossy button with animated shimmer sweep.
 * Fully self-contained — pure CSS animation, no framer-motion needed.
 */
...
/**
 * Simpler variant: AnimatedShinyText — inline gradient sweep text label
 */
